...
namespace Proyecto_Nuevo_Avatar_V2.Pages.ADM_Roles
{
    public class EditModel : PageModel
    {
        ...
        public EditModel(IRolesApiClient rolesApiClient, ILoginApiClient loginApiClient)
        {
        ...
        [BindProperty]
        public Rol RolEditado { get; set; } = new();
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            var rol = await _rolesApiClient.ObtenerRolPorId(id, token);
            if (rol == null)
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var (Exito, Mensaje, RolActualizado) = await _rolesApiClient.CRUDRoles(RolEditado, token, "Update");

            TempData["Resultado"] = Exito ? "Rol actualizado correctamente." : Mensaje;
